        ...
        <div className="mt-20 w-full max-w-screen-2xl flex flex-col-reverse md:flex-row md:justify-between items-center py-20 px-8">
          <div className="mt-10">
            <h1 className="font-bold text-2xl md:text-3xl xl:text-4xl">
              <Typewriter
                options={{
                  strings: ['Desenvolvedor Fullstack', 'Freelancer', 'Desenvolvedor Web'],
                  autoStart: true,
                  loop: true,
                  delay: 75,
                }}
            ...
            <p className="font-normal mt-4 max-w-md">Meu nome é João, um Desenvolvedor Web apaixonado por criar  experiências digitais extraordinárias. Este é o meu playground virtual,  onde a criatividade se encontra com a funcionalidade!</p>
            <p className="font-normal mt-6 max-w-md">Se você está em busca de um parceiro para transformar sua visão em  realidade digital, você está no lugar certo. Vamos trabalhar juntos e  fazer algo incrível acontecer!</p>
